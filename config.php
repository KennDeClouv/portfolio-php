...
define('CONTACTFORM_TO_ADDRESS', 'zuuliziluuz@gmail.com');
define('CONTACTFORM_TO_NAME', 'KennDeClouv');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'zuuliziluuz@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'izra kksy ksua pliw');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6Lcv0x0qAAAAAEFC4FxEhrOB_YKSzuLJX93-h-aJ');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6Lcv0x0qAAAAAHc6_eEYlGKjabbz6tUo1GhsiClq');
