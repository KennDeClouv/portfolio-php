...
<head>
  ...
  <link rel="stylesheet" href="../assets/style/css/thanks.min.css" />
  <link rel="shortcut icon" href="../assets/img/favicon.webp" type="image/x-icon">

  <meta name="description"
    content="Professional web developer specializing in creating responsive, high-performance websites and applications. Expert in HTML, CSS, JavaScript, and modern frameworks. Let's build your next project together!">
  <meta name="keywords"
  ...
  <title>Thanks | KennDeClouv</title>
</head>

<body>
  <div id="cursor-wrapper"></div>
  <section class="d-flex mt-2 ms-2 rounded-3" style="height: calc(100vh - 16px); width: calc(100vw - 16px);">
    <div class="m-auto text-center text-light">
      <h1 class="fs-10">THANKS</h1>
      <h2 class="fs-4 opacity-50">ill reply your email as soon as possible</h2>
      <a href="../" class="btn mt-4 w-50">Main page</a>
    </div>
  </section>
